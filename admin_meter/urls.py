...
urlpatterns = [
    ...
    path('create/apartment=<apartment_id>', MeterNewValue.as_view(), name='meter-new-value'),
    path('create/apartment_id=<apartment_id>_service=<service_id>', MeterNewValue.as_view(),
    ...
    path('meter_list/apartment=<apartment_id>', MeterViewList.as_view(), name='meter-view-list-apart'),
