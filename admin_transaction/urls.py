...
urlpatterns = [
    ...
    path('personal_account=<personal_account>', TransactionList.as_view(), name='transaction_list_personal_account'),
    ...
    path('create/type=<transaction_type>/personal_account_id=<personal_account_id>', TransactionCreate.as_view(),
