...
from admin_website.forms import (
    MainPageForm,
    SeoForm,
    BlockFormSet,
    ContactPageForm,
...
class MainPageUpdate(AdminPermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            context["main_page_form"] = MainPageForm(
                self.request.POST,
                self.request.FILES,
            ...
            context["seo_form"] = SeoForm(
                self.request.POST, instance=self.object.seo, prefix="seo"
            )
            context["block_formset"] = BlockFormSet(
                self.request.POST,
                self.request.FILES,
                queryset=self.object.block_set.all(),
                prefix="block",
            )
        else:
            context["main_page_form"] = MainPageForm(
                instance=self.object, prefix="main_page"
            )
...
class ContactPageUpdate(AdminPermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            context["contact_page_form"] = ContactPageForm(
                self.request.POST, instance=self.object, prefix="contact_page"
            )
            context["seo_form"] = SeoForm(
                self.request.POST, instance=self.object.seo, prefix="seo"
            )
            ...
            context["contact_page_form"] = ContactPageForm(
                instance=self.object, prefix="contact_page"
            )
            context["seo_form"] = SeoForm(instance=self.object.seo, prefix="seo")
        return context
...
class ServicePageUpdate(AdminPermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            context["services_page_form"] = ServicePageForm(
                self.request.POST,
                self.request.FILES,
                instance=self.object,
            ...
            context["service_block_formset"] = ServiceBlockFormSet(
                self.request.POST,
                self.request.FILES,
            ...
            context["services_page_form"] = ServicePageForm(
                instance=self.object, prefix="services_page"
            )
            context["seo_form"] = SeoForm(instance=self.object.seo, prefix="seo")
            context["service_block_formset"] = ServiceBlockFormSet(
                queryset=self.object.serviceblock_set.all(), prefix="service_block"
            )
        return context
    ...
    def post(self, request, *args, **kwargs):
        ...
        if (
            services_page_form.is_valid()
            and seo_form.is_valid()
            and service_block_formset.is_valid()
        ):
            seo_form.save()
...
class TariffPageUpdate(AdminPermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        if self.request.POST:
            context["tariffs_page_form"] = TariffPageForm(
                self.request.POST,
                self.request.FILES,
                instance=self.object,
                prefix="tariffs_page",
            ...
            context["tariff_block_formset"] = TariffBlockFormSet(
                self.request.POST,
                self.request.FILES,
            ...
            context["tariffs_page_form"] = TariffPageForm(
                instance=self.object, prefix="tariffs_page"
            )
            context["seo_form"] = SeoForm(instance=self.object.seo, prefix="seo")
            context["tariff_block_formset"] = TariffBlockFormSet(
                queryset=self.object.tariffblock_set.all(), prefix="tariff_block"
            )
        return context
    ...
    def post(self, request, *args, **kwargs):
        ...
        if (
            tariffs_page_form.is_valid()
            and seo_form.is_valid()
            and tariff_block_formset.is_valid()
        ):
            seo_form.save()
...
class AboutPageUpdate(AdminPermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["additional_gallery_list"] = AdditionalGallery.objects.filter(
            about_page=self.object
        )
        if self.request.POST:
            ...
            context["about_page_form"] = AboutPageForm(
                instance=self.object, prefix="about_page"
            )
            context["seo_form"] = SeoForm(instance=self.object.seo, prefix="seo")
            context["document_formset"] = DocumentFormSet(
                queryset=self.object.document_set.all(), prefix="document"
            )
    ...
    def post(self, request, *args, **kwargs):
        ...
        if (
            about_page_form.is_valid()
            and seo_form.is_valid()
            and document_formset.is_valid()
            and gallery_form.is_valid()
            and additional_gallery_form.is_valid()
        ):
            print("asdasdasd")
            seo_form.save()
...
class GalleryDelete(AdminPermissionRequiredMixin, DeleteView):
    ...
    model = Gallery
    success_url = reverse_lazy("website_about_page")
    success_message = "Зображення з фотогалереї успішно видалено"
...
class AdditionalGalleryDelete(GalleryDelete):
    ...
    success_message = "Зображення з додаткової фотогалереї успішно видалено"
